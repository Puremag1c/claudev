...
**Осталось обсудить:**
- [ ] Architect — формат плана, как разбивает задачи на 1-5 мин
- [ ] Analysts — нужны ли все 4 (UX/Security/OPS/Reliability) для MVP
- [ ] Senior Analyst vs Senior Executor — дублирование?
- [ ] Executors — параллельно или последовательно, git workflow
- [ ] Формат задачи в beads — что должно быть чтобы Executor понял
