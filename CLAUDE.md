...
Мы дорабатываем прототип системы и приводим его к production-ready состоянию.

**Цель:** система должна легко интегрироваться в любой проект через `git clone`.
...
bash core/scripts/detect-phase.sh

# Проверить синтаксис агента
cat core/agents/manager.md
```
